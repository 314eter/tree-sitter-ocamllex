LANGUAGE_NAME := tree-sitter-ocamllex
HOMEPAGE_URL := https://github.com/314eter/tree-sitter-ocamllex
VERSION := 0.25.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/ocamllex '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/ocamllex
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/ocamllex
